...
class PycaImage():
    ...
    def set_image_size(self):
        if self.size0 != None and self.size1 != None and self.size2 != None:
            ...
            #print 'set_image_size', width, height, format
            self.img = QImage(width, height, iformat)
            if iformat == QImage.Format_Indexed8:
            ...
            try:
                ...
                self.data_pv.set_processor(buf, size, width, height, bytesPerLine, iformat)
            except:
                pass
