...
epicsEnvSet( "LOCATION",  "LAS:R52:IOC:33" )
epicsEnvSet( "IOC",       "ioc-las-gige2")
epicsEnvSet( "IOCSH_PS1", "$(IOC)> " )

epicsEnvSet("PREFIX", "LAS:GIGE2:")
...
$(EVR_ENABLED) dbLoadRecords( "db/evrPmc230.db",  "IOC=LAS:R52:IOC:33,EVR=LAS:R52:EVR:33" )

# Load record instances
dbLoadRecords( "db/iocAdmin.db",			"IOC=LAS:R52:IOC:33" )
dbLoadRecords( "db/save_restoreStatus.db",	"IOC=LAS:R52:IOC:33" )

# Setup autosave
set_savefile_path( "$(IOC_DATA)/$(IOC)/autosave" )
set_requestfile_path( "autosave" )
save_restoreSet_status_prefix("LAS:R52:IOC:33")
