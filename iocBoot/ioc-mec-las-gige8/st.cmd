...
epicsEnvSet( "IOC",       "ioc-mec-las-gige8")
epicsEnvSet( "IOCSH_PS1", "$(IOC)> " )

epicsEnvSet("PREFIX", "MEC:LAS:")
epicsEnvSet("CAM",   "CAM8")
epicsEnvSet("IMG",   "IMAGE8")

# ----- Manta G-145B -----
epicsEnvSet("C_IP",         "192.168.107.2")
...
prosilicaConfigIp(  "$(CAM)", 999999, "$(C_IP)", 50, -1)
epicsThreadSleep(1)
...
dbLoadRecords( "db/iocAdmin.db",		"IOC=IOC:MEC:LAS:GIGE8" )
dbLoadRecords( "db/save_restoreStatus.db",	"IOC=IOC:MEC:LAS:GIGE8" )

# Setup autosave
set_savefile_path( "$(IOC_DATA)/$(IOC)/autosave" )
set_requestfile_path( "autosave" )
save_restoreSet_status_prefix("IOC:MEC:LAS:GIGE8")
