...
epicsEnvSet( "LOCATION",  "MEC:M64A:44" )
...
dbLoadRecords( "db/iocAdmin.db",		"IOC=IOC:MEC:GIGE2" )
dbLoadRecords( "db/save_restoreStatus.db",	"IOC=IOC:MEC:GIGE2" )

# Setup autosave
set_savefile_path( "$(IOC_DATA)/$(IOC)/autosave" )
set_requestfile_path( "autosave" )
save_restoreSet_status_prefix("IOC:MEC:GIGE2")
