...
# For development
cd ~/working/ioc/common/gigECam/current/iocBoot/$IOC
...
$RUNUSER "$PROCSERV --logfile $IOC_DATA/$IOC/iocInfo/ioc.log_$CREATE_TIME --name $IOC 32502 ./st.cmd"
