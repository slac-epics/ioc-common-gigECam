...
# ----- Manta G046B -----
epicsEnvSet("IP",     "192.168.100.10")
epicsEnvSet("XSIZE",  "780")
epicsEnvSet("YSIZE",  "580")
epicsEnvSet("COLORMODE",  "0")        # 0=Mono, 2=RGB1
epicsEnvSet("NELEMENTS",  "452400")   # X * Y

# ----- Manta G146C -----
##epicsEnvSet("IP",     "192.168.100.10")
##epicsEnvSet("XSIZE",  "1388")
##epicsEnvSet("YSIZE",  "1038")
##epicsEnvSet("COLORMODE",  "2")        # 0=Mono, 2=RGB1
##epicsEnvSet("NELEMENTS",  "4322232")  # X * Y * 3
# -----------------------
...
#
dbpf $(PREFIX)$(CAM1):ColorMode $(COLORMODE)         # 0=Mono, 2=RGB1
...
#
dbpr $(PREFIX)$(CAM1):ArrayCounter_RBV

# Start autosave backups
create_monitor_set("tst_gige1.req", 30, "IOC=$(LOCATION),CAM=$(PREFIX)$(CAM1),IMG=$(PREFIX)$(IMG1)")
