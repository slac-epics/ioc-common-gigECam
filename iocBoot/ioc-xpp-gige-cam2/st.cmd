...
epicsEnvSet( "LOCATION", "XPP:R37:IOC:14:GIGE:02" )
epicsEnvSet( "IOCSH_PS1", "ioc-xpp-gige-cam2> " )
< envPaths
cd( "../.." )
...
dbLoadRecords( "db/iocAdmin.db",			"IOC=XPP:IOC:GIGE:02" )
dbLoadRecords( "db/save_restoreStatus.db",	"IOC=XPP:IOC:GIGE:02" )

# Setup autosave
set_savefile_path( "$(IOC_DATA)/$(IOC)/autosave" )
set_requestfile_path( "$(TOP)/autosave" )
save_restoreSet_status_prefix( "XPP:IOC:GIGE:02:" )
...
create_monitor_set( "autosave_gige.req", 5, "IOC=XPP:IOC:GIGE:02" )
